...
- results: `..\mulita-extractor-training\output_heldout\mulita-qwen2.5-1.5b\zap\20260809T220145Z_ZAP_bWAPP_mulita-qwen2.5-1.5b\results.json`
...
solution     -      -       -           -           0.805    0.805   
impact       -      -       -           -           n/a      n/a     
references   -      0.958   0.958       -           -        -       
severity     1.000  -       -           -           -        -       
port         n/a    -       -           -           -        -       
protocol     n/a    -       -           -           -        -       
plugin       0.833  -       -           -           -        -       
...
- **solution**: Server Leaks Information via "X-Powered-By" HTTP Response Header Field(s) (0.5); Server Leaks Version Information via "Server" HTTP Response Header Field (0.512); X-Content-Type-Options Header Missing (0.817)
- **references**: Server Leaks Information via "X-Powered-By" HTTP Response Header Field(s) (0.75)
- **plugin**: Application Error Disclosure (0.0)
- **instances**: Server Leaks Information via "X-Powered-By" HTTP Response Header Field(s) (0.0); Server Leaks Version Information via "Server" HTTP Response Header Field (0.0); X-Content-Type-Options Header Missing (0.0); Missing Anti-clickjacking Header (0.9)
